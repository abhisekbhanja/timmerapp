            ...
            <input
              ...
              className={` ${
                touched.title && !isTitleValid
                  ? 'border-red-500 w-full px-3 py-2 border rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
                  : 'border-gray-300 w-full px-3 py-2 border rounded-md shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500'
              }`}
